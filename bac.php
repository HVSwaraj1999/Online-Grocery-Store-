...
<head>
	...
	<script src="scriptbac.js"></script>
...
<body>
	...
	<div class="container">
        <div class="sidebar">
		<aside>
            <img src="Pics\BreakfastandCereal\BreakfastandCereal.jpg" alt="Side Image">
        </aside>
		...
		<div class="main-content">
			...
			<select id="categorySelect">
					...
					<option value="cerealshop">Cereal Shop</option>
					<option value="pancakes-waffles">Pancakes and Waffles</option>
					<option value="breakfastbreads">Breakfast Breads</option>
					<option value="oatmeal-grits">Oatmeal and Grits</option>
