...
<head>
	...
	<script src="scriptcan.js"></script>
...
<body>
	...
	<div class="container">
        <div class="sidebar">
		<aside>
            <img src="Pics\Candy\candy.jpg" alt="Side Image">
        </aside>
		...
		<div class="main-content" >
            <h1>Candies</h1>
			<p>Ava- kitkat, mams, snickers, swedishfish</p>
			...
			<div id="outOfStock" style="display: none;">
				<p>The requested candy is out of stock.</p>
			</div>
