...
<head>
	...
	<script src="scriptsnk.js"></script>
...
<body>
	...
	<div class="container">
        <div class="sidebar">
		<aside>
            <img src="Pics\Snack\Snacks.jpg" alt="Side Image">
        </aside>

		</div>
		<div class="main-content">
            <h1>Snacks</h1>
			<p>Ava- Tortilla, Popcorn, Pretzels, Cookies</p>
			
			<form id="snacksForm">
				<input type="text" id="snacksName" placeholder="Enter snacks name">
			...
			<div id="outOfStock" style="display: none;">
				<p>The requested snacks is out of stock.</p>
			</div>
